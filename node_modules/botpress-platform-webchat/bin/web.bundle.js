...
var startOfWeek = __webpack_require__(68)
...
var _trackHelper = __webpack_require__(24);
...
exports.WebBotpressUIInjection = exports.Web = exports.Emulator = undefined;
...
var _reactResizableBox = __webpack_require__(30);
...
var Emulator = exports.Emulator = function (_React$Component) {
  ...
  function Emulator(props) {
    ...
    _this.toggleCollapsed = function () {
      if (!_this.state.collapsed) {
        var originalHeight = _this.resizable.state.height;
        var originalWidth = _this.resizable.state.width;
        _this.resizable.updateSize({ height: 40 });
        _this.setState({ originalHeight: originalHeight, originalWidth: originalWidth, collapsed: true });
      } else {
        _this.resizable.updateSize({ height: _this.state.originalHeight, width: _this.state.originalWidth });
        _this.setState({ collapsed: false });
      }
    };

    _this.startNewSession = function (event) {
      event.preventDefault();
      event.stopPropagation();

      _this.session.startNewSession();
    };

    _this.session = new ChatSession({ events: props.bp.events });
  ...
  _createClass(Emulator, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var className = (0, _classnames3.default)(_style2.default.chatComponent, 'bp-modules-chat');

      var chatComponent = _react2.default.createElement(Chat, { showWelcome: true, className: className, session: this.session });

      this.setState({ chatComponent: chatComponent });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var minHeight = this.state.collapsed ? 40 : 400;
      var maxheight = this.state.collapsed ? 40 : 1000;

      var emulatorStyle = (0, _classnames3.default)(_style2.default.emulator, _defineProperty({}, _style2.default.hidden, this.state.collapsed));

      return _react2.default.createElement(
        'div',
        { className: emulatorStyle },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: _style2.default.header, onClick: this.toggleCollapsed },
            _react2.default.createElement(
              'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: _style2.default.button, onClick: this.startNewSession },
                _react2.default.createElement(
                  'i',
...
var Web = exports.Web = _web2.default;

var INJECTION_ID = 'botpress-platform-webchat-injection';
var INJECTION_URL = '/api/botpress-platform-webchat/inject.js';

var WebBotpressUIInjection = exports.WebBotpressUIInjection = function (_React$Component2) {
  _inherits(WebBotpressUIInjection, _React$Component2);

  function WebBotpressUIInjection() {
    _classCallCheck(this, WebBotpressUIInjection);

    return _possibleConstructorReturn(this, (WebBotpressUIInjection.__proto__ || Object.getPrototypeOf(WebBotpressUIInjection)).apply(this, arguments));
  }

  _createClass(WebBotpressUIInjection, [{
    ...
    value: function componentWillMount() {
      ...
      Object.assign(button, {
        ...
        onclick: function onclick() {
          return window.botpressWebChat.sendEvent({ type: 'show' });
        },
        innerHTML: '\n        <a role="button" href="#">\n          <span class="bp-full-screen">\n            <span class="glyphicon glyphicon-comment"></span>\n          </span>\n        </a>\n      '
      });

      var target = document.querySelector('.bp-navbar-module-buttons') || document.querySelector('.nav.navbar-nav');
...
var _resizer = __webpack_require__(34);
...
var _add_milliseconds = __webpack_require__(36);

var _add_milliseconds2 = _interopRequireDefault(_add_milliseconds);

var _is_before = __webpack_require__(37);
...
var _convo = __webpack_require__(41);

var _convo2 = _interopRequireDefault(_convo);

var _side = __webpack_require__(50);
    ...
    value: function fetchConversations() {
      ...
      return axios.get(url).then(function (_ref2) {
        ...
        return new Promise(function (resolve) {
          return _this6.setState({ conversations: data }, resolve);
        });
      });
    }
  }, {
...
// module
exports.push([module.i, ".botpress-platform-webchat__style__input___3yaCn {\n  outline: none; }\n  .botpress-platform-webchat__style__input___3yaCn textarea {\n    font: inherit;\n    background-color: transparent;\n    min-height: 32px;\n    max-height: 96px;\n    margin-bottom: 0;\n    font-size: 14px;\n    padding: 8px;\n    width: 100%;\n    border: none;\n    resize: none;\n    line-height: 1.2; }\n", ""]);
...
var _distance_in_words_to_now = __webpack_require__(51);
...
var compareDesc = __webpack_require__(53)
var parse = __webpack_require__(1)
var differenceInSeconds = __webpack_require__(54)
...
var parse = __webpack_require__(1)
var differenceInCalendarMonths = __webpack_require__(56)
var compareAsc = __webpack_require__(57)
...
var _difference_in_minutes = __webpack_require__(71);

var _difference_in_minutes2 = _interopRequireDefault(_difference_in_minutes);

var _reactLinkify = __webpack_require__(72);
...
var _quick_replies = __webpack_require__(84);

var _quick_replies2 = _interopRequireDefault(_quick_replies);

var _login_prompt = __webpack_require__(87);

var _login_prompt2 = _interopRequireDefault(_login_prompt);

var _file = __webpack_require__(88);
...
var getDayOfYear = __webpack_require__(63)
var getISOWeek = __webpack_require__(67)
var getISOYear = __webpack_require__(23)
var parse = __webpack_require__(1)
...
var parse = __webpack_require__(1)
var startOfYear = __webpack_require__(64)
...
var startOfDay = __webpack_require__(66)
...
var parse = __webpack_require__(1)
var startOfISOWeek = __webpack_require__(11)
var startOfISOYear = __webpack_require__(69)
...
var _linkifyIt = __webpack_require__(73);

var _linkifyIt2 = _interopRequireDefault(_linkifyIt);

var _tlds = __webpack_require__(79);
...
function compile(self) {
  ...
  var re = self.re = __webpack_require__(74)(self.__opts__);
...
module.exports = function (opts) {
  ...
  re.src_Any = __webpack_require__(75).source;
  re.src_Cc  = __webpack_require__(76).source;
  re.src_Z   = __webpack_require__(77).source;
  re.src_P   = __webpack_require__(78).source;
...
var _reactFileInput = __webpack_require__(86);
...
exports.locals = {
	...
	"session_reset": "botpress-platform-webchat__style__session_reset___3_pAT",
...
var _reactSlick = __webpack_require__(90);
...
var _innerSlider = __webpack_require__(92);

var _objectAssign = __webpack_require__(5);

var _objectAssign2 = _interopRequireDefault(_objectAssign);

var _json2mq = __webpack_require__(101);
...
var _canUseDom = __webpack_require__(103);
...
var enquire = _canUseDom2.default && __webpack_require__(104);
...
var _eventHandlers = __webpack_require__(93);
...
var _initialState = __webpack_require__(94);
...
var _createReactClass = __webpack_require__(95);
...
var _track = __webpack_require__(98);

var _dots = __webpack_require__(99);

var _arrows = __webpack_require__(100);
...
var camel2hyphen = __webpack_require__(102);
...
var MediaQueryDispatch = __webpack_require__(105);
...
var MediaQuery = __webpack_require__(106);
...
var QueryHandler = __webpack_require__(107);
var each = __webpack_require__(26).each;
...
// module
exports.push([module.i, "@charset 'UTF-8';\n/* Slider */\n.slick-loading .slick-list\n{\n    background: #fff url(" + escape(__webpack_require__(113)) + ") center center no-repeat;\n}\n\n/* Icons */\n@font-face\n{\n    font-family: 'slick';\n    font-weight: normal;\n    font-style: normal;\n\n    src: url(" + escape(__webpack_require__(27)) + ");\n    src: url(" + escape(__webpack_require__(27)) + "?#iefix) format('embedded-opentype'), url(" + escape(__webpack_require__(114)) + ") format('woff'), url(" + escape(__webpack_require__(115)) + ") format('truetype'), url(" + escape(__webpack_require__(116)) + "#slick) format('svg');\n}\n/* Arrows */\n.slick-prev,\n.slick-next\n{\n    font-size: 0;\n    line-height: 0;\n\n    position: absolute;\n    top: 50%;\n\n    display: block;\n\n    width: 20px;\n    height: 20px;\n    padding: 0;\n    -webkit-transform: translate(0, -50%);\n    -ms-transform: translate(0, -50%);\n    transform: translate(0, -50%);\n\n    cursor: pointer;\n\n    color: transparent;\n    border: none;\n    outline: none;\n    background: transparent;\n}\n.slick-prev:hover,\n.slick-prev:focus,\n.slick-next:hover,\n.slick-next:focus\n{\n    color: transparent;\n    outline: none;\n    background: transparent;\n}\n.slick-prev:hover:before,\n.slick-prev:focus:before,\n.slick-next:hover:before,\n.slick-next:focus:before\n{\n    opacity: 1;\n}\n.slick-prev.slick-disabled:before,\n.slick-next.slick-disabled:before\n{\n    opacity: .25;\n}\n\n.slick-prev:before,\n.slick-next:before\n{\n    font-family: 'slick';\n    font-size: 20px;\n    line-height: 1;\n\n    opacity: .75;\n    color: white;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n}\n\n.slick-prev\n{\n    left: -25px;\n}\n[dir='rtl'] .slick-prev\n{\n    right: -25px;\n    left: auto;\n}\n.slick-prev:before\n{\n    content: '\\2190';\n}\n[dir='rtl'] .slick-prev:before\n{\n    content: '\\2192';\n}\n\n.slick-next\n{\n    right: -25px;\n}\n[dir='rtl'] .slick-next\n{\n    right: auto;\n    left: -25px;\n}\n.slick-next:before\n{\n    content: '\\2192';\n}\n[dir='rtl'] .slick-next:before\n{\n    content: '\\2190';\n}\n\n/* Dots */\n.slick-dotted.slick-slider\n{\n    margin-bottom: 30px;\n}\n\n.slick-dots\n{\n    position: absolute;\n    bottom: -25px;\n\n    display: block;\n\n    width: 100%;\n    padding: 0;\n    margin: 0;\n\n    list-style: none;\n\n    text-align: center;\n}\n.slick-dots li\n{\n    position: relative;\n\n    display: inline-block;\n\n    width: 20px;\n    height: 20px;\n    margin: 0 5px;\n    padding: 0;\n\n    cursor: pointer;\n}\n.slick-dots li button\n{\n    font-size: 0;\n    line-height: 0;\n\n    display: block;\n\n    width: 20px;\n    height: 20px;\n    padding: 5px;\n\n    cursor: pointer;\n\n    color: transparent;\n    border: 0;\n    outline: none;\n    background: transparent;\n}\n.slick-dots li button:hover,\n.slick-dots li button:focus\n{\n    outline: none;\n}\n.slick-dots li button:hover:before,\n.slick-dots li button:focus:before\n{\n    opacity: 1;\n}\n.slick-dots li button:before\n{\n    font-family: 'slick';\n    font-size: 6px;\n    line-height: 20px;\n\n    position: absolute;\n    top: 0;\n    left: 0;\n\n    width: 20px;\n    height: 20px;\n\n    content: '\\2022';\n    text-align: center;\n\n    opacity: .25;\n    color: black;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n}\n.slick-dots li.slick-active button:before\n{\n    opacity: .75;\n    color: black;\n}\n", ""]);
...
// module
exports.push([module.i, ".botpress-platform-webchat__style__emulator___2OaKd {\n  background-color: white;\n  z-index: 1000;\n  position: absolute;\n  bottom: 0px;\n  right: 200px;\n  border-top-left-radius: 5px;\n  border-top-right-radius: 5px;\n  border: 1px solid #46cba0;\n  border-bottom: none; }\n  .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP {\n    width: 100%;\n    height: 40px;\n    background-color: #46cba0;\n    padding: 0 15px;\n    color: white;\n    position: relative;\n    cursor: pointer; }\n    .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP:hover, .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP:hover .botpress-platform-webchat__style__left___3m7qz {\n      background-color: #47D3A9; }\n    .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__left___3m7qz {\n      float: left;\n      line-height: 40px;\n      padding: 0 10px;\n      z-index: 100;\n      position: relative;\n      background-color: #46cba0; }\n    .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__right___3dYWY {\n      position: absolute;\n      right: -12px;\n      top: -5px;\n      z-index: 99;\n      height: 40px; }\n    .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__button___2CpBv {\n      cursor: pointer; }\n      .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__button___2CpBv:hover {\n        color: #C9FFDC; }\n      .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__button___2CpBv + .botpress-platform-webchat__style__button___2CpBv {\n        margin-left: 5px; }\n      .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__header___3vZKP .botpress-platform-webchat__style__button___2CpBv i {\n        vertical-align: middle !important; }\n  .botpress-platform-webchat__style__emulator___2OaKd .botpress-platform-webchat__style__chat___31MQH {\n    height: calc(100% - 50px);\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    /* align items in Main Axis */\n    align-items: stretch;\n    /* align items in Cross Axis */\n    align-content: stretch; }\n  .botpress-platform-webchat__style__emulator___2OaKd.botpress-platform-webchat__style__hidden___AJRCW .botpress-platform-webchat__style__chat___31MQH {\n    display: none !important; }\n\n.botpress-platform-webchat__style__embedded___2oY8s .botpress-platform-webchat__style__chat___31MQH {\n  height: calc(100vh);\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  /* align items in Main Axis */\n  align-items: stretch;\n  /* align items in Cross Axis */\n  align-content: stretch; }\n", ""]);

// exports
exports.locals = {
	"emulator": "botpress-platform-webchat__style__emulator___2OaKd",
	"header": "botpress-platform-webchat__style__header___3vZKP",
	"left": "botpress-platform-webchat__style__left___3m7qz",
	"right": "botpress-platform-webchat__style__right___3dYWY",
	"button": "botpress-platform-webchat__style__button___2CpBv",
	"chat": "botpress-platform-webchat__style__chat___31MQH",
	"hidden": "botpress-platform-webchat__style__hidden___AJRCW",
	"embedded": "botpress-platform-webchat__style__embedded___2oY8s"
};
