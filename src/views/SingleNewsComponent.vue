...
export default defineComponent({
  ...
  async created() {
    try {
      ...
      this.item_data = {
        urlToImage: data[itemID].urlToImage || '', 
        title: data[itemID].title,
        publishedAt: data[itemID].publishedAt,
        content: data[itemID].content || '',
      };
      this.formattedDate()
    } catch (error) {
  ...
  <div v-else class="pb-[120px]  flex flex-col gap-10">
    ...
    <div class="px-[10%] text-justify font-serif flex flex-col gap-8">
      ...
      <p>{{ item_data.content }} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam eum vel voluptas
        ...
        labore! Eum totam, veritatis placeat perferendis ipsam suscipit qui numquam natus quas amet non, dolorum
        quisquam
        ...
        omnis delectus ullam distinctio illo, dolorum beatae saepe ducimus, aperiam laudantium sunt nulla atque. Hic,
        aut.
        ...
        consequuntur doloribus dolore excepturi. Asperiores explicabo et corporis vero distinctio sed laudantium
        pariatur
        ...
        ipsa praesentium illo atque ut magnam? Reiciendis neque maiores labore hic temporibus praesentium quibusdam
        quod,
        ...
        mollitia explicabo repudiandae cum placeat quae dicta eos quia deserunt soluta, ipsum odio quis obcaecati
        dolores.
